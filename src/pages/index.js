...
export default function Home() {
    ...
    return (
        <>
            ...
            <div className="hero min-h-screen shadow-lg">
                <div className="hero-overlay bg-opacity-90">
                    <div className='opacity-70'>
                        <Image src={"/images/bg.webp"} layout="fill" objectFit="cover" className="bg-cover bg-center" />
                    </div>
                </div>
                <div className="card w-72 rounded-xl backdrop-blur border-2 animate-swipe-right">
                    <figure>
                        <Image src={avatar} className="mask mask-squircle scale-75" width={500} height={500} />
                    </figure>
                    <h1 className="text-center text-3xl text-white">Derry & Virginia</h1>
                    <div className="card-body">
                        <p className="text-center text-white">Kepada Yth.</p>
                        <p className="text-center text-white">Mohon maaf apabila terdapat kesalahan nama/gelar</p>
                    </div>
                </div>
            </div>
            ...
            <section className="shadow-lg pb-5 pt-10" id="mempelai">
                ...
                <div className="container mx-auto content-center">
                    <div className="grid grid-cols-2 justify-center gap-4">
                        <div className="m-4 mr-0 my-20 max-w-full rounded-lg bg-blue-100 py-4 px-8 shadow-lg justify-center md:gap-4">
                        ...
                        <div className="ml-0 my-20 max-w-full rounded-lg bg-pink-100 py-4 px-8 shadow-lg justify-center md:gap-4">
                            <div className="-mt-16 flex justify-center md:justify-end ">
            ...
            <section className="shadow-lg pb-5 pt-10" id="mempelai2">
